...
const MobileNav = ({closeNav, showNav}: Props) => {
  ...
  <div>
    ...
    <div className={`text-white ${navOpen} transform transition-all duration-500 delay-100 fixed justify-center flex flex-col h-full w-[80%] sm:w-[60%] bg-[#0f0715]
    space-y-6 z-[10000]`}>
            ...
            return (
                <Link key={navlink.id} href={navlink.url}>
                    ...
                    onClick={closeNav}>{navlink.label}</p>
                </Link>
            );
        })}
